...
(defvar peakburn-colors-alist
  '(("peakburn-fg"       . "#DCDCCC")
    ("peakburn-fg-1"     . "#656555")
    ("peakburn-bg-1"     . "#2B2B2B")
    ("peakburn-bg-05"    . "#383838")
    ("peakburn-bg"       . "#3F3F3F")
    ("peakburn-bg+1"     . "#4F4F4F")
    ("peakburn-bg+2"     . "#5F5F5F")
    ("peakburn-bg+3"     . "#6F6F6F")
    ...
    ("peakburn-orange"   . "#DFAF8F")
    ("peakburn-yellow"   . "#F0DFAF")
    ("peakburn-yellow-1" . "#E0CF9F")
    ("peakburn-yellow-2" . "#D0BF8F")
    ("peakburn-green-1"  . "#5F7F5F")
    ("peakburn-green"    . "#7F9F7F")
    ("peakburn-green+1"  . "#8FB28F")
    ("peakburn-green+2"  . "#9FC59F")
    ("peakburn-green+3"  . "#AFD8AF")
    ("peakburn-green+4"  . "#BFEBBF")
    ("peakburn-cyan"     . "#93E0E3")
    ("peakburn-blue+1"   . "#94BFF3")
    ("peakburn-blue"     . "#8CD0D3")
    ("peakburn-blue-1"   . "#7CB8BB")
    ("peakburn-blue-2"   . "#6CA0A3")
    ("peakburn-blue-3"   . "#5C888B")
    ("peakburn-blue-4"   . "#4C7073")
    ("peakburn-blue-5"   . "#366060")
    ("peakburn-magenta"  . "#DC8CC3"))
...
;;;;; basic coloring
   ...
   `(cursor ((t (:foreground ,peakburn-fg :background "white"))))
